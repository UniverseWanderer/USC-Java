...
private:
	...
	ListType *table;			// a pointer to the start of hash table

	int numBuckets() const;		// calculate the number of buckets
	int findLongest() const;	// find the longest link in the table
